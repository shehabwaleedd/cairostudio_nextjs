                ...
                <div className="showCase__container" ref={containerRef} {...handlers}>
                    {projects.map((item, index) => (
                        <React.Fragment key={item.id}>
                            <Link to={`/case-study/${item.title}`} className="slider slider--bg">
                            ...
                            <Link to={`/case-study/${item.title}`} className="slider slider--fg">
                                <div ref={el => innerSmallRef.current[index] = el} className={`slider__item-small ${current === index ? 'slider__item--current-small' : ''}`}>
                                    <div className="slider__item-inner-small" style={{ backgroundImage: `url(${item.homePage})` }}></div>
                                </div>
                            </Link>
                        </React.Fragment>
                    ))}
